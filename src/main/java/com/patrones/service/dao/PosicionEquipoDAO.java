    ...
    public List<PosicionEquipo> obtenerPosicionesEquiposTemporada(int anio) {
        ...
        try (Connection conn = conexionBD.getConnection();
            ...
            while (rs.next()) {
                ...
                // FACTORY METHOD
                PosicionEquipo equipo = crearPosicionEquipo(
                        idEquipo,
                        nombre,
                        pilotos,
                        puntos,
            ...
            System.err.println("Ocurrió un error al obtener posiciones de equipos: " + e.getMessage());
        }
        return posiciones;
    }

    //FACTORY METHOD
    protected PosicionEquipo crearPosicionEquipo(
            int idEquipo,
            String nombre,
            String pilotos,
            int puntos,
